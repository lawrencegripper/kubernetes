...
The `github.com/lawrencegripper/azure-sdk-for-go/storage` package is used to perform REST operations against the [Azure Storage Service](https://docs.microsoft.com/en-us/azure/storage/). To manage your storage accounts (Azure Resource Manager / ARM), use the [github.com/lawrencegripper/azure-sdk-for-go/arm/storage](https://github.com/lawrencegripper/azure-sdk-for-go/tree/master/arm/storage) package. For your classic storage accounts (Azure Service Management / ASM), use [github.com/lawrencegripper/azure-sdk-for-go/management/storageservice](https://github.com/lawrencegripper/azure-sdk-for-go/tree/master/management/storageservice) package.
